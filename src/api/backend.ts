...
export const getSyncPerfReport = callable<[], { success: boolean; report?: Record<string, unknown>; formatted?: string; error?: string }>("get_sync_perf_report");
...
export const reportSyncFinalized = callable<[Record<string, number>, number[], boolean], { success: boolean }>("report_sync_finalized");
