...
def _rewind_to_v4(db_path: str) -> None:
    ...
    version stamp AND the pre-006/007/008/009/010/011 schema (006's play-session
    ...
    absent, and 011's platform_sync_state table absent) so the sequential
    005→…→011 re-run applies cleanly.
    """
